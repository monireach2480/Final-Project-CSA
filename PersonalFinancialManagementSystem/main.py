...
class PersonalFinanceManager:
    def __init__(self, root):
        ...
        self.root.geometry("800x600")  # Set a fixed size for better layout
    ...
    def setup_style(self):
        ...
        # Define colors
        bg_color = "#EAEAEA"  # Softer background color
        button_bg_color = "red"  # Green button color
        button_fg_color = "white"
        
        # Configure styles
        style.configure("TFrame", background=bg_color)
        style.configure("TButton", padding=10, font=("Arial", 12), background=button_bg_color, foreground=button_fg_color)
        style.map("TButton", background=[("active", "#45a049")])
        
        style.configure("TLabel", font=("Arial", 12), background=bg_color)
        style.configure("TEntry", font=("Arial", 12), relief="flat", padding=5)
        
        # Treeview styles
        style.configure("Treeview.Heading", font=("Arial", 12), background=button_bg_color, foreground=button_fg_color)
        style.configure("Treeview", font=("Arial", 11), background=bg_color)
    ...
    def add_buttons_to_main_frame(self):
        # Set a uniform style for buttons
        ...
        self.set_budget_button.grid(row=0, column=0, padx=10, pady=10)  # Increased padding for better spacing

        self.view_budget_button = ttk.Button(
            self.main_frame, 
            text="View Budget", 
            command=self.view_budget, 
            state=tk.DISABLED,
            style=button_style
        )
        self.view_budget_button.grid(row=0, column=1, padx=10, pady=10)
        ...
        self.add_expense_button.grid(row=0, column=2, padx=10, pady=10)
        ...
        self.generate_report_button.grid(row=0, column=3, padx=10, pady=10)
        ...
        self.register_button.grid(row=0, column=6, padx=10, pady=10)

        self.delete_account_button = ttk.Button(
            self.main_frame, 
            text="Delete Account", 
            command=self.show_delete_account_window, 
            state=tk.DISABLED,
            style=button_style
        )
        self.delete_account_button.grid(row=0, column=7, padx=10, pady=10)
    ...
    def show_login_window(self):
        ...
        self.login_window.geometry("300x200")  # Set a fixed size for better layout
        ...
        self.username_entry = ttk.Entry(
            self.login_window, justify="left", style="TEntry")
        ...
        self.password_entry = ttk.Entry(
            self.login_window, justify="left", show="*", style="TEntry")
        self.password_entry.grid(row=1, column=1, padx=10, pady=10)

        # Submit Button
        self.submit_login_button = ttk.Button(
            self.login_window, text="Login", command=self.validate_login)
        self.submit_login_button.grid(row=2, column=0, columnspan=2, pady=20)  # Increased padding for better spacing
    ...
    def show_add_expense(self):
        ...
        self.date_cal = DateEntry(self.add_expense_window, background='darkblue',
                                  foreground='white', borderwidth=2, year=2024, month=11, day=28)  # Customize as needed
